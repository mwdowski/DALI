...
template <typename T>
void RunForName(const DALIWaveletName &name, kernels::KernelManager &kmgr, size_t size,
                size_t device, kernels::KernelContext &ctx, TensorListView<StorageGPU, T> &out,
